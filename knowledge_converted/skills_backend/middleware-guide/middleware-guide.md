...
- [Middleware Guide - Express Middleware Patterns](#middleware-guide---express-middleware-patterns)
  - [Table of Contents](#table-of-contents)
  - [Authentication Middleware](#authentication-middleware)
    - [SSOMiddleware Pattern](#ssomiddleware-pattern)
  - [Audit Middleware with AsyncLocalStorage](#audit-middleware-with-asynclocalstorage)
    - [Excellent Pattern from Blog API](#excellent-pattern-from-blog-api)
  - [Error Boundary Middleware](#error-boundary-middleware)
    - [Comprehensive Error Handler](#comprehensive-error-handler)
  - [Composable Middleware](#composable-middleware)
    - [withAuthAndAudit Pattern](#withauthandaudit-pattern)
  - [Middleware Ordering](#middleware-ordering)
    - [Critical Order (Must Follow)](#critical-order-must-follow)
