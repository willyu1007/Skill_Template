...
- [Async Patterns and Error Handling](#async-patterns-and-error-handling)
  - [Table of Contents](#table-of-contents)
  - [Async/Await Best Practices](#asyncawait-best-practices)
    - [Always Use Try-Catch](#always-use-try-catch)
    - [Avoid .then() Chains](#avoid-then-chains)
  ...
  - [Error Propagation](#error-propagation)
    - [Proper Error Chains](#proper-error-chains)
  - [Common Async Pitfalls](#common-async-pitfalls)
    - [Fire and Forget (Bad)](#fire-and-forget-bad)
