...
- [Testing Guide - Backend Testing Strategies](#testing-guide---backend-testing-strategies)
  - [Table of Contents](#table-of-contents)
  - [Unit Testing](#unit-testing)
    - [Test Structure](#test-structure)
  - [Integration Testing](#integration-testing)
    - [Test with Real Database](#test-with-real-database)
  ...
  - [Testing Authenticated Routes](#testing-authenticated-routes)
    - [Using test-auth-route.js](#using-test-auth-routejs)
    - [Mock Authentication in Tests](#mock-authentication-in-tests)
