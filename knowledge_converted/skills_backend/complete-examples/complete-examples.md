...
- [Complete Examples - Full Working Code](#complete-examples---full-working-code)
  - [Table of Contents](#table-of-contents)
  - [Complete Controller Example](#complete-controller-example)
    - [UserController (Following All Best Practices)](#usercontroller-following-all-best-practices)
  - [Complete Service with DI](#complete-service-with-di)
    - [UserService](#userservice)
  - [Complete Route File](#complete-route-file)
    - [userRoutes.ts](#userroutests)
  - [Complete Repository](#complete-repository)
    - [UserRepository](#userrepository)
  - [Refactoring Example: Bad to Good](#refactoring-example-bad-to-good)
    - [BEFORE: Business Logic in Routes ❌](#before-business-logic-in-routes-)
    - [AFTER: Clean Separation ✅](#after-clean-separation-)
  - [End-to-End Feature Example](#end-to-end-feature-example)
    - [Complete User Management Feature](#complete-user-management-feature)
...
**Related Files:**
- [backend_guideline.md](backend_guideline.md)
