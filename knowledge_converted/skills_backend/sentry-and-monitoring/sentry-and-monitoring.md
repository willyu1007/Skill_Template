...
- [Sentry Integration and Monitoring](#sentry-integration-and-monitoring)
  - [Table of Contents](#table-of-contents)
  - [Core Principles](#core-principles)
  - [Sentry Initialization](#sentry-initialization)
    - [instrument.ts Pattern](#instrumentts-pattern)
  - [Error Capture Patterns](#error-capture-patterns)
    - [1. BaseController Pattern](#1-basecontroller-pattern)
    - [2. Workflow Error Handling](#2-workflow-error-handling)
    - [3. Service Layer Error Handling](#3-service-layer-error-handling)
